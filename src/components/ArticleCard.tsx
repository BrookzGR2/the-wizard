...
export function ArticleCard({ article }: { article: ArticleMeta }) {
  return (
    <Link href={`/articles/${article.slug}`} className="block group">
      <article className="relative p-5 sm:p-6 rounded-2xl border border-wizard-border/40 bg-wizard-card/50 backdrop-blur-sm hover-glow transition-all duration-300 group-hover:border-wizard-purple/40 group-hover:bg-wizard-card/80">
